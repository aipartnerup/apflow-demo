...
for apflow's JWT middleware.

Uses apflow's generate_token and verify_token functions for consistency.
"""
...
def generate_demo_jwt_token(user_id: str, expires_in_days: int = 365) -> str:
    ...
    Uses apflow's generate_token function for consistency with the library.
    ...
    # Use apflow's generate_token (uses python-jose internally)
...
def verify_demo_jwt_token(token: str) -> Optional[Dict[str, Any]]:
    ...
    Uses apflow's verify_token function for consistency with the library.
    
    This function is used as verify_token_func for apflow's JWT middleware.
...
def get_user_id_from_token(token: str) -> Optional[str]:
    ...
    Uses python-jose for consistency with apflow.
